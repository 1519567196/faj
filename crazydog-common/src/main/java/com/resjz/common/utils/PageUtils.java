...
public class PageUtils implements Serializable {
	...
	public static PageUtils page(Object object,int currentPage,int pageSize){
		...
		page.setList(pageObjects);
		page.setPageSize(pageSize);
		page.setTotalCount(list.size());
		page.setTotalPage((int)Math.ceil((double)list.size()/pageSize));
		return page;
	}
